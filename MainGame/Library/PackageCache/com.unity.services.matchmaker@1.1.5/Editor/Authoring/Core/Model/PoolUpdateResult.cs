...
{
    internal class PoolUpdateResult
    {
        ...
        private  static  (List<PoolName> poolsCreated, List<PoolName> poolsUpdated, List<PoolName> poolsDeleted)
        ...
        private static List<PoolName> GetAllPoolNamesFromPool(BasePoolConfig poolConfig)
        {
